...
public class GoogleEdit extends Observer{
    public GoogleEdit(Customer customer_) {
    ...
    public void update() throws IOException, GeneralSecurityException {
        ...
        final String spreadsheetId = "1IcPX9N1y7tQYrXRv5-4cTJ9qNzplmcMfmeCWVmhEL5g";
        ...
        ValueRange requestBody  = new ValueRange().setValues(Arrays.asList(
                Arrays.asList(s[0] + " change to " + s[1])));
